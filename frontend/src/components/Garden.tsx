    ...
    return (
        ...
        >
            ...
            >
                ...
                {cappedStage >= 1 && (
                    <path
                        d="M60 132 C 52 126 47 132 51 138 C 56 140 60 136 60 132 Z"
                        fill="#A8B5A0"
                    />
                )}
                {cappedStage >= 3 && (
                    <path
                        d="M60 122 C 68 116 73 122 69 128 C 64 130 60 126 60 122 Z"
                        fill="#B7C2AE"
                    />
                )}
                {cappedStage >= 6 && (
                    <path
                        d="M60 108 C 50 102 45 108 49 114 C 55 116 60 112 60 108 Z"
                        fill="#A8B5A0"
                    />
                )}
                {cappedStage >= 10 && (
