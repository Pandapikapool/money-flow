                ...
                <>
                    ...
                    <section className="glass-panel" style={{ padding: '24px' }}>
                        ...
                        >
                            {story.by_day.map((d) => {
                                const isBig =
                                    story.biggest_day && d.date === story.biggest_day.date;
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            title={`${d.weekday}: ${formatCurrency(d.total)}`}
                                            style={{
                                                width: '100%',
                        ...
                        {story.biggest_day && (
                            ...
                            >
                                ...
                                <span style={{ color: 'var(--text-primary)', fontWeight: 500 }}>
                                    {story.biggest_day.weekday}
                                </span>{' '}
                                — {formatCurrency(story.biggest_day.total)}.
                            </div>
                        )}
                    </section>
                                    ...
                                    return (
                                        <div key={c.tag}>
                                            ...
                                            <div
                                                style={{
                                                    height: '5px',
                                                    background: 'rgba(122, 111, 102, 0.12)',
                                                    borderRadius: '3px',
                                                    overflow: 'hidden',
                                                }}
                                            >
