...
import {
    ...
    type SIPSummary, type RDSummary, type StocksSummary
} from "../lib/api";
    ...
    useEffect(() => {
        const loadAll = async () => {
            ...
            try {
                ...
                const [dashData, fixedData, sipData, rdData, indStocks, usStocksData, accounts, lifeXp] = await Promise.all([
