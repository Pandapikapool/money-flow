...
export default function StocksPage() {
    ...
    // Notes state
    const [stocksNotes, setStocksNotes] = useState<Record<string, string>>(
        getStocksNotes(validMarket)
    );
        ...
        <div style={{ maxWidth: '1400px' }}>
            ...
            >
                ...
                <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                        ...
                        >
                            {totalProfitLoss >= 0 ? '+' : ''}
                            {formatValue(totalProfitLoss)} ({overallReturns.toFixed(2)}%)
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="glass-panel" style={{ padding: '24px', marginBottom: '24px' }}>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <input
                                    type="number"
                                    step="any"
                                    value={newInvestedValue}
                                    onChange={(e) => setNewInvestedValue(e.target.value)}
                ...
                {holdingItems.length === 0 ? (
                    ...
                    >
                        No holdings yet. Click "+ Add" to add your first{' '}
                        {validMarket === 'crypto' ? 'crypto' : 'stock'}.
                    </p>
                ) : (
                            ...
                            <tbody>
                                {holdingItems.map((item) => (
                                    ...
                                    >
                                        ...
                                        <td style={{ padding: '12px 8px', textAlign: 'right' }}>
                                            {editingPriceId === item.id ? (
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setInlinePriceValue(e.target.value)
                                                    }
                                                    onBlur={() => saveInlinePrice(item.id)}
                                                    onKeyDown={(e) =>
                                                        handleInlinePriceKeyDown(e, item.id)
                                                    }
                                                    autoFocus
                                        ...
                                        <td style={{ padding: '12px 8px', textAlign: 'right' }}>
                                            {formatValue(item.invested_value)}
                                        </td>
                                        <td
                                            style={{
                                                padding: '12px 8px',
            ...
            {soldItems.length > 0 && (
                <div
                    ...
                    style={{ padding: '24px', marginBottom: '24px', opacity: 0.85 }}
                >
                        ...
                        >
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                ...
                                <span style={{ fontWeight: '600' }}>
                                    {formatValue(sellingItem.invested_value)}
                                </span>
                            </div>
                        </div>
                            ...
                            {sellPrice && (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span style={{ fontWeight: '600' }}>
                                            {formatValue(
                                                sellingItem.quantity * parseFloat(sellPrice)
                                            )}
                                        </span>
                                    </div>
                                    <div
