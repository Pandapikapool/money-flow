    ...
    const getBudgetStatus = () => {
        ...
        if (remaining < 0)
            return {
                ...
                text: `Over by ${formatCurrency(Math.abs(remaining))}`,
            };
        if (percentUsed >= 90)
            return {
                color: '#ff9800',
                text: `${formatCurrency(remaining)} left (${(100 - percentUsed).toFixed(0)}%)`,
            };
        return {
    ...
    return (
        <div style={{ maxWidth: '900px' }}>
            ...
            <div style={{ marginBottom: '24px' }}>
                ...
                <h1 style={{ fontSize: '1.75rem', fontWeight: '600', margin: '8px 0 0' }}>
                    {monthName} {year}
                </h1>
            </div>
                                        ...
                                        {specialTags.length > 0 && (
                                            <div>
                                                ...
                                                >
                                                    {specialTags.map((st) => {
                                                        const isSelected =
                                                            editSelectedSpecialTagIds.includes(
                                                                st.id
                                                            );
                                                        return (
                                                            <div
                                ...
                                >
                                    <div style={{ flex: 1 }}>
                                        ...
                                        >
                                            ...
                                            {expenseSpecialTags[e.id] &&
                                                expenseSpecialTags[e.id].length > 0 && (
                                                    <>
                                                        {expenseSpecialTags[e.id].map((stId) => {
                                                            const st = specialTags.find(
                                                                (t) => t.id === stId
                                                            );
                                                            return st ? (
                                                                <span
